...
public class HighestSalaryExample {
    ...
    public static void main(String[] args) {
        ...
        Map.Entry<String, Integer> result3 = getNthHighestSalary(2, map2);

        Map.Entry<Integer, List<String>> result2 = getNthHighestSalarybetter(1, map2);
    ...
    public static Map.Entry<Integer, List<String>> getNthHighestSalarybetter(int num, Map<String, Integer> map) {
        return map.entrySet().stream()
